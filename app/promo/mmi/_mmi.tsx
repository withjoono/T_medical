  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="space-y-8">
        {blocks.map((week) => (
          <div key={week[0]} className="overflow-x-auto border border-hair-strong bg-paper-50">
...
export function TeacherCards() {
  return (
    <div className="grid overflow-hidden border-l border-t border-hair bg-paper-50 sm:grid-cols-2">
      {TEACHERS.map((t) => (
        <div key={t.id} className="border-b border-r border-hair p-8">
